...
import { Building2, Check, Heart, Target, Users, Zap } from 'lucide-react';
...
export default function About() {
    return (
        <>
            <Head title="About - SwiftPay" />
            <div className="flex min-h-screen flex-col">
                <PublicNav />

                <PublicInnerHero
                    title="About SwiftPay"
                    description="Empowering South African businesses with automated payment and payroll solutions built for local needs."
                />
                    ...
                    <PublicSectionInner narrow>
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            <p className="mt-4 text-lg text-muted-foreground">
                                ...
                                We combine bank-controlled escrow, full tax compliance (PAYE, UIF, SDL), time tracking,
                                and employee self-service in one place—so you can run payments and payroll with
                                confidence.
                            </p>
                        </div>
                    </PublicSectionInner>
                    ...
                    <PublicSectionInner>
                        ...
                        <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                            <div className="rounded-lg border bg-card p-6 transition-[box-shadow,transform] duration-200 hover:-translate-y-1 hover:shadow-md">
                                ...
                                <h3 className="font-display text-xl font-semibold">Built for South Africa</h3>
                            ...
                            <div className="rounded-lg border bg-card p-6 transition-[box-shadow,transform] duration-200 hover:-translate-y-1 hover:shadow-md">
                                ...
                                <h3 className="font-display text-xl font-semibold">Full Tax Compliance</h3>
                                <p className="mt-2 text-muted-foreground">
                            ...
                            <div className="rounded-lg border bg-card p-6 transition-[box-shadow,transform] duration-200 hover:-translate-y-1 hover:shadow-md">
                                ...
                                <h3 className="font-display text-xl font-semibold">Business-First Approach</h3>
                                <p className="mt-2 text-muted-foreground">
                            ...
                            <div className="rounded-lg border bg-card p-6 transition-[box-shadow,transform] duration-200 hover:-translate-y-1 hover:shadow-md">
                                ...
                                <h3 className="font-display text-xl font-semibold">Transparent & Trustworthy</h3>
                                <p className="mt-2 text-muted-foreground">
                            ...
                            <div className="rounded-lg border bg-card p-6 transition-[box-shadow,transform] duration-200 hover:-translate-y-1 hover:shadow-md">
                                ...
                                <h3 className="font-display text-xl font-semibold">Zero Manual Work</h3>
                                <p className="mt-2 text-muted-foreground">
                            ...
                            <div className="rounded-lg border bg-card p-6 transition-[box-shadow,transform] duration-200 hover:-translate-y-1 hover:shadow-md">
                                ...
                                <h3 className="font-display text-xl font-semibold">Scalable Solutions</h3>
                                <p className="mt-2 text-muted-foreground">
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="rounded-lg border-2 border-primary/20 bg-primary/5 p-8 dark:bg-primary/10">
                            ...
                            <p className="text-lg text-muted-foreground">
                                ...
                                SwiftPay is built from the ground up with local needs in mind:
                            </p>
                ...
                <AnimatedSection className="bg-muted/50 py-16">
                    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-8 space-y-6 text-lg text-muted-foreground">
                            <p>
                                SwiftPay was born from a simple observation: South African businesses were spending too
                            ...
                            <p>
                                ...
                                the highest standards of security, compliance, and transparency. The result is SwiftPay
                            ...
                            <p>
                                Today, SwiftPay serves businesses across South Africa, from small startups to growing
                ...
                <AnimatedSection>
                    <PublicCtaBand
                        ...
                        description="Experience the difference that a platform built specifically for South African businesses can make. Start your free trial today."
                    >
                        <Link href={register()}>
