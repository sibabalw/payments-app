...
export default function DeductionsCreate({ businesses, selectedBusinessId, employee }: any) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Custom Deduction" />
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <Card>
                    <CardHeader>
                        <CardTitle>Create Custom Deduction</CardTitle>
                    </CardHeader>
                    <CardContent>
