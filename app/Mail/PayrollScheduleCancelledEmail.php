...
class PayrollScheduleCancelledEmail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            ...
            subject: 'Payroll Schedule Cancelled: '.$this->payrollSchedule->name,
        );
    }
    ...
    {
        return new Content(
            view: 'emails.payroll-schedule-cancelled',
            with: [
                'user' => $this->user,
